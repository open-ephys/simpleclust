function [handle,data_info] = ddt_read_memmap(filename, chns, time, downsample_rate)
...
%tmp = fread(fid, sizedata, 'int16', 0);%2*16);%2*16*16);
...
data_info.T= [0:nsamples-1]./samp_rate;
